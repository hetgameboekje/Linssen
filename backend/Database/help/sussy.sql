...
-- Dumping data for table linssen.buttonpress: ~0 rows (approximately)

-- Dumping data for table linssen.users: ~9 rows (approximately)
REPLACE INTO `users` (`User_ID`, `username`, `password`) VALUES
	...
	(8, 'Stan', '$2y$10$b5I2exz38DDDpMhUhBKt5.LakKTcGa4zU1Iz74v5LFyG.Bwhd8ZgG'),
	(9, 'john', '$2y$10$VFKHOwHAK958DuNZGr1Wl.pCjDVA2bcW72MxYD4AunL.3Q4VIevDy');
